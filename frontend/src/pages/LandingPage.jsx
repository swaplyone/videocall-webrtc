...
import { ChevronDown, CheckCircle, ArrowRight, Sparkles } from 'lucide-react';

import OpeningSequence from '../components/landing/OpeningSequence';
...
export default function LandingPage({ currentUser }) {
  ...
  return (
    <div style={{ position: 'relative', background: '#030712', color: '#FFF', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', overflowX: 'hidden' }}>
      {/* SCENE 0: Cinematic Silent Opening Sequence */}
      {!openingCompleted && (
        <OpeningSequence onBegin={handleBeginExperience} />
      )}

      {/* 60 FPS Fluid Bioluminescent Particle Canvas */}
      <AbyssalFluidCanvas exploded={exploded} vortexActive={vortexActive} onVortexComplete={handleVortexComplete} />
      ...
      {openingCompleted && (
        ...
        >
          {/* SCENE 1: Sunlit Surface - Bioluminescent Hero */}
          <AbyssHero
          ...
          {/* SCENE 2: Twilight Zone - Kinetic Node Fusion Playground (500m) */}
          <div id="fusion-engine">
            <KineticFusionEngine />
          </div>

          {/* SCENE 3: Feature Galaxy */}
          <FeatureGalaxy />

          {/* SCENE 4: Midnight Zone - Refraction Anti-Capture Privacy Shield (1000m) */}
          <RefractionPrivacyShield />

          {/* SCENE 5: LIVE STATS COUNTER */}
          ...
          {/* SCENE 6: ABYSSAL FLOOR - SIGNATURE MOMENT CTA */}
          <div style={{ position: 'relative', zIndex: 1, padding: '5rem 1.5rem', textAlign: 'center', background: 'linear-gradient(180deg, #0B132B, #030712)', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 900, textTransform: 'uppercase', marginBottom: '1rem' }}>
              You've Explored Ours.
            </h2>
            <p style={{ color: '#94A3B8', fontSize: '1.1rem', maxWidth: '540px', margin: '0 auto 2.5rem auto' }}>
              Now build yours. Reserve your spot in our daily rollout batch and experience privacy-first skill communication.
            </p>
            <button
      ...
      {/* Signature Logo Collapse Beta Portal Modal */}
